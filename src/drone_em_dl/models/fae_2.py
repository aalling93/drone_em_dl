...
class Fae():
    ...
    def make_model(self,
                   ...
                   dense_neurons:list = [228,128,56],
                   laten_space_regularisation_L1:float=0.0005,name:str="AE_tobias"):
        ...
        encoder2 = tf.keras.layers.Dense(units=latent_space_dim, name="encoder2_output_interm")(encoder2)
        
         
        encoder12_output = tf.keras.layers.Add()([encoder_output, encoder2])
        encoder12_output = tf.keras.layers.Dense(units=latent_space_dim, activity_regularizer=tf.keras.regularizers.L1(laten_space_regularisation_L1), name="encoder2_output")(encoder12_output)
